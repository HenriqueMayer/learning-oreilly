...
- Why **Containers**?
    - E.g., Deploy a NodeJS app:
    1. Install NodeJS dependencies
    2. Install NodeJS itself
    3. Install app's dependencies
    4. Run the app

    - Containers **encapsulate** all the dependencies and configuration necessary.
```
Devs: 
write Dockerfile
      |
Build and Push **image** --> Ops: provide some information **if** nneeded
                                                |
                                              Deploy     
```
---
